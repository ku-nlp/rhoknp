...
#     morpheme_texts = ["天気", "が", "いい", "ので", "散歩", "した", "。"]
#     knp = """# S-ID:2 KNP:5.0-2ad4f6df DATE:2021/08/05 SCORE:-10.73865
...
#     doc = load_knp(knp)
#     for morpheme_text, morpheme in zip(morpheme_texts, doc.morphemes):
#         assert morpheme_text == morpheme.text
