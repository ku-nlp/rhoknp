...
# 。 。 。 特殊 1 句点 1 * 0 * 0 NIL <英記号><記号><文末><付属>""",
        texts=["天気", "が", "いい", "ので", "散歩", "した", "。"],
    )
]


@pytest.mark.parametrize("knp,texts", [astuple(case) for case in cases])
def test_morpheme(knp: str, texts: list[str]):
    # doc = load_knp(knp)
    # for i, morpheme in enumerate(doc.morphemes):
